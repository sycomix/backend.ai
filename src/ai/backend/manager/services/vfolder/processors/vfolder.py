...
class VFolderProcessors(AbstractProcessorPackage):
    ...
    get_live_usage_v2: SingleEntityActionProcessor[
    ...
    def __init__(
        ...
        self.get_live_usage_v2 = SingleEntityActionProcessor(
            service.get_live_usage_v2, action_monitors, validators=single_entity_rbac_validators
        )
