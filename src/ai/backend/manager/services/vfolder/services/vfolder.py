...
class VFolderService:
    ...
    async def get_live_usage_v2(
        ...
        if vfolder_data.unmanaged_path:
            return GetVFolderLiveUsageActionResult(vfolder_id=vfolder_data.id, usage=None)
